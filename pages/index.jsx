            ...
            <div className="section hero-started">
              ...
              >
                ...
                <div className="description">
                  <div>
                    <p>
                      From Mumbai, India. I am a Full Stack Developer with 3.6
                      years of experience in web and app-based products,
                      specializing in Laravel PHP with MySQL, Node.js with
                      MongoDB, and React. Currently working as a Backend
                      Developer, I deliver robust and scalable solutions.
                      Available for freelance projects. Let's connect to discuss
                      how I can contribute to your project.
                    </p>
                  </div>
                  <div className="social-links">
                    <a target="_blank" rel="nofollow" href="https://www.linkedin.com/in/sutarvivek">
              ...
              >
                <img
                  decoding="async"
                  src="assets/images/profile-viveksutar.png"
                  alt="<b>Zoé</b> Miller"
                />
              ...
              <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <div className="skills-items">
                  ...
                  >
                    ...
                    <div className="dots">
                      <div className="dot" style={{ width: "40%" }}>
                        <span />
                      </div>
                    </div>
                    <div className="value">
              ...
              <div className="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <div className="numbers-items">
                  ...
                  >
                    ...
                    <div className="lui-text">
                      <span> viveksutar003@gmail.com </span>
                    </div>
                  </div>
